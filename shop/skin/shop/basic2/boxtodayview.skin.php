...
<aside id="stv">
    <div id="stv_list">
        ...
        <ul id="stv_nb">
            <li><a href="<?php echo G5_SHOP_URL; ?>/cart.php"><img src="<?php echo G5_SHOP_URL; ?>/img/hd_nb_cart2.gif" alt="장바구니"></a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/wishlist.php"><img src="<?php echo G5_SHOP_URL; ?>/img/hd_nb_wish2.gif" alt="위시리스트"></a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php"><img src="<?php echo G5_SHOP_URL; ?>/img/hd_nb_deli2.gif" alt="주문/배송조회"></a></li>
        </ul>
    </div>
</aside>
