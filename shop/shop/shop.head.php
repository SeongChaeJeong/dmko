     ...
     <!-- 헤더 시작 -->
      <div id="head_wrap">
            <!-- 글로벌 시작  -->
             <div id="global_box">
                 <div id="global">
                     ...
                     <div class="global_left">
                     	<div class="btn_kakao"><a href="#"><img src="/shop/img/btn_kakao.png" alt="카톡문의"></a></div>
                     	<div class="btn_home"><a href="<?php echo $default['de_root_index_use'] ? G5_URL : G5_SHOP_URL; ?>/">HOME</a></div>
                     	<div class="btn_add"><a href="javascript:window.external.AddFavorite('http://dmko.net' , '뎀코라이트');"> 즐겨찾기</a></div>
                     </div>
             ...
             <div id="global_cs_mu">
             	<ul>
                	<li><a href="#"> <span class="point1">설치</span>서비스</a></li>
                	<li><a href="<?php echo G5_URL ?>/bbs/board.php?bo_table=qa"> Q&amp;A</a></li>
                	<li><a href="<?php echo G5_URL ?>/bbs/board.php?bo_table=photo">설치시공사례</a></li>
                	<li><a href="<?php echo G5_URL ?>/bbs/board.php?bo_table=int_tip"> 인테리어<span class="point2">Tip</span></a></li>
                	<li class="point3"><a href="#">b2b기업회원</a></li>
                </ul>    
             </div>
        	<!-- 게시판메뉴 //--> 
